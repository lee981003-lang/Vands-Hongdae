...
const action:Record<string,string>={bed_status_change:"상태 변경",bed_follow_up_change:"후속 관리 변경",bed_details_change:"고객/시술 변경"};
const field:Record<string,string>={status:"상태",customer_name:"고객명",treatment_name:"시술명",is_follow_up:"후속 관리"};
const values:Record<string,string>={empty:"빈 룸",in_treatment:"시술 중",waiting:"시술 대기"};
